...
import { ArrowRightIcon, BeakerIcon, ChartBarIcon } from '@heroicons/react/24/outline';
      ...
      >
        ...
        >
          <div>
            ...
            <p className="text-gray-300 text-sm">Entdecken Sie unsere pharmazeutischen Lösungen</p>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
              ...
              <div key={product.id} className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-green-600 font-medium">Reinheit: {product.purity}</span>
                  </div>
          ...
          <div className="text-center py-8">
            <p className="text-gray-600 mb-4">Mehr Produkte in unserem vollständigen Katalog</p>
            <Link href="/categories" className="inline-flex items-center bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Entdecken Sie unsere umfassende Auswahl an pharmazeutischen Produkten, 
              alle laborgeprüft und in höchster Qualität gefertigt.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 lg:p-12">
            <div className="text-center mb-12">
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Bestseller Produkte</h3>
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-green-600 font-medium">Reinheit: {product.purity}</span>
