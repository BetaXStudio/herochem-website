          ...
          <div className="max-w-2xl mx-auto space-y-8">
              ...
              {features.map((feature, index) => (
                <div key={index} className="flex items-center space-x-3">
                  <div className="flex-shrink-0">
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#e91111' }}>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3">
              <button
                ...
                className="inline-flex items-center justify-center px-7 py-3 text-white font-medium rounded-xl transition-all duration-300 transform hover:scale-105"
                style={{
              ...
              <div className="flex flex-row gap-3">
                <button
                  ...
                  className="flex-1 sm:flex-initial inline-flex items-center justify-center px-7 py-3 border border-gray-600 hover:border-red-600 text-gray-300 hover:text-white font-medium rounded-xl transition-all duration-300 hover:bg-red-600/10"
                  style={{ boxShadow: '0 4px 15px rgba(255, 255, 255, 0.05)' }}
                >
                  FAQ
                </button>
                <button
