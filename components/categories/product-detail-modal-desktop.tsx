        ...
        >
          <div className="flex min-h-screen relative overflow-hidden hide-scrollbar" style={{ background: "white" }}>
            <div className="relative z-10 flex w-full">
              ...
              >
                <style>{`
                  @media (min-width: 768px) { main { padding-top: 140px !important; } }
                `}</style>
                
                {/* Categories Page Container mit seitlichen Abständen */}
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  {/* Header with back button - wie ProductDetailOverlay */}
                  <div className="relative mb-2" style={{ height: "40px" }}>
                    <button
                      onClick={onCloseAction}
                      className="absolute left-0 p-2 text-gray-900 hover:text-red-600 z-10 cursor-pointer"
                      style={{
                        top: "50%",
                  ...
                  {/* Upper Section - Product Image and Info */}
                  <div className="flex gap-8 mb-8">
                    ...
                    <div className="flex-shrink-0">
                      ...
                      {/* Price and Add to Cart Section - Under Image */}
                      <div className="w-96 mt-4 flex items-center justify-between gap-4 py-3 bg-gray-50 rounded-lg relative z-20">
                        {/* Price */}
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                            ...
                            <span className="px-2 border-x border-gray-300 min-w-[38px] text-center font-medium text-gray-900" style={{ fontSize: '13px', height: '26px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                              {quantity}
                            </span>
                            <button
                    ...
                    {/* Right Side - Trust Info and Brand Label */}
                    <div className="flex-1 flex flex-col gap-6">
                      {/* Chemical Description */}
                      <div className="mb-4">
                        <h3 className="text-lg font-semibold text-gray-900 mb-2">Chemical Description</h3>
                        <div 
                      ...
                      <div className="flex-1">
                        <div className="space-y-3">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-gray-700">Third-party tested for identity, purity and concentration</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="flex-shrink-0">
                              <svg className="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span className="text-sm text-gray-700">Each product has a unique code to check authenticity</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <div className="flex-shrink-0">
                              <svg className="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span className="text-sm text-gray-700">Certified by WHO-GMP, and compliant with EUGMP and UKMHRA</span>
                          </div>
                        </div>

                        {/* Product Details - moved here from bottom */}
                        <div className="mt-8">
                          <style
                            dangerouslySetInnerHTML={{
                              __html: `
                    ...
                    {/* Brand Label - positioned at the top right */}
