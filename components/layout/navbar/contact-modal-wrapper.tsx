        ...
        >
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)] max-[800px]:max-h-[calc(90vh-225px)]">
            ...
            <div className="space-y-4">
              <a
                href="https://wa.me/message/WGZRNL24TGNFH1"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center space-x-3 bg-[#25D366] hover:bg-[#1da851] text-white py-2.5 lg:py-3 px-4 rounded-xl font-medium lg:text-lg transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center space-x-3 bg-blue-600 hover:bg-blue-700 text-white py-2.5 lg:py-3 px-4 rounded-xl font-medium lg:text-lg transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
