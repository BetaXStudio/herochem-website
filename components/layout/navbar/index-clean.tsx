...
export function Navbar() {
  ...
  return (
    <nav
      ...
      style={{
        boxShadow:
          "0 6px 12px -2px rgba(0, 0, 0, 0.5), 0 4px 8px -2px rgba(0, 0, 0, 0.15)",
        zIndex: 10001,
      }}
    >
        ...
        <div className="flex w-full md:w-1/3 gap-2 md:gap-4 lg:gap-6">
          ...
          >
            ...
            <div className="ml-2 flex-none text-sm font-medium uppercase md:hidden lg:block">
              <span>hero</span>
              <span style={{ color: "#eb1313" }}>chem</span>
            </div>
          </Link>
                  ...
                  >
                    ...
                    >
                      <div className="relative flex flex-col items-center mt-0">
                        ...
                        <ul
                          className="flex flex-col items-center bg-[rgb(64,64,74)] shadow-lg shadow-black/30 border-t border-neutral-700 mt-0 pt-4 text-center"
                          style={{
                            borderRadius: "0 0 0.75rem 0.75rem", // Updated to match cart modal consistency
                            boxShadow:
                              "0 2px 8px 0 rgba(0,0,0,0.25), 0 -2px 8px 0 rgba(0,0,0,0.15)",
                          }}
                        >
