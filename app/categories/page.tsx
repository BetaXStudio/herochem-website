...
const ProductCard = memo(({ product, onAddToCart, onDetailsClick }: { 
  ...
  return (
    <div 
      className="bg-transparent rounded-md flex flex-col mb-8 w-full md:max-w-[160pt] ml-1 box-border max-w-[calc(100vw-2rem)] mx-auto md:mx-0 md:ml-1"
      style={{ paddingRight: '4px' }}
      onMouseEnter={handleMouseEnter}
      onMouseLeave={handleMouseLeave}
    >
      <div 
        className="w-full rounded mb-1 flex items-center justify-center relative p-2 aspect-square" 
        style={{
...
function CategoriesContent() {
  ...
  // Modal handlers
  const handleDetailsClick = useCallback((e: React.MouseEvent, product: Product) => {
    e.stopPropagation();
  ...
  return (
    <>
      <div className="flex min-h-screen relative overflow-hidden hide-scrollbar" style={{ contain: 'layout style' }}>
        ...
        <div className="relative z-10 flex w-full">
          ...
          <main 
            className="flex-1 px-4 md:px-8 pb-16 hide-scrollbar" 
            style={{ 
        ...
        {currentCategory !== 'ALL PRODUCTS' && selectedBrand && (
          <div className="mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 mb-8" style={STATIC_STYLES.gridContainer}>
